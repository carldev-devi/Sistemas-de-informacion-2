...
public class DatabaseConnection {
    ...
    private static final String HOST = "switchback.proxy.rlwy.net";
    private static final String PORT = "21285"; // <-- REEMPLAZA con tu puerto de Railway
    private static final String DATABASE = "railway"; // <-- REEMPLAZA con el nombre de tu BD
    private static final String USER = "root";
    private static final String PASSWORD = "wgGyeSEgojKuEIkAXrcgEakdasUubgNn";
